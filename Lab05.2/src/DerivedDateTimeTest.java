...
class DerivedDateTimeTest {
    ...
    public static void testPresidentsFirst100Days() {
        ...
        LocalDate deadline = inaugDate.plusDays(100);
    ...
    public static void testEarlyRetirement() {
        // TODO
        LocalDate bday = LocalDate.of(2000, 2, 14);
        LocalDate retire1 = bday.plusYears(59).plusMonths(6);
        System.out.println(retire1);
    }
    ...
    public static void testLaborDay() {
        // TODO
        LocalDate bday = LocalDate.of(2000, 9, 14);
        LocalDate labor = bday.with(TemporalAdjusters.nextOrSame(MONDAY));
